...
import { LogOut, Plus, Trash2, ExternalLink, CheckCircle2, Eye, Pencil } from 'lucide-react';
...
const REQUIRED_FIELD_GETTERS: ((d: DraftProfile) => boolean)[] = [
  (d) => Boolean(d.slug),
  (d) => Boolean(d.photo),
...
function Dashboard() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#F9FAFB] pb-28 lg:pb-16" style={dashStyle}>
            ...
            <Card title="Identité">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  {draft.photo && (
                    <img src={draft.photo} alt="Photo" className="w-14 h-14 rounded-xl object-cover shrink-0" />
                  )}
              ...
              {draft.services.map((service, i) => (
                <div key={i} className="border border-gray-200 rounded-xl p-3 flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs font-semibold text-red-500 w-fit"
                  >
